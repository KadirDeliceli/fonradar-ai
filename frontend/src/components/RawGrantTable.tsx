...
export function RawGrantTable({ grants }: GrantTableProps) {
    return (
        <div className="overflow-hidden rounded-lg border border-gray-200">
            <div className="border-b border-gray-200 bg-gray-50 py-4 text-center">
            ...
            <table className="w-full text-left text-sm">
                <thead className="border-b border-gray-200 bg-gray-50 text-gray-600">
                    <tr>
                        <th className="px-4 py-3 font-medium w-[6%] whitespace-nowrap">Fon ID</th>
                        <th className="px-4 py-3 font-medium w-[76%]">
                            Başlık
                        </th>
